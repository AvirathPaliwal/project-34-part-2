...
function setup() {
   ...
   rope = new Rope (bob.p, { x: 340, y: 200 } ); 
   rope2 = new Rope (bob2.p, { x: 390, y: 200 });
   rope3 = new Rope (bob3.p,{x:440,y:200});
   rope4 = new Rope (bob4.p,{x:490,y:200});
   rope5 = new Rope (bob5.p,{x:540,y:200});
